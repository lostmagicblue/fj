...
$sql = <<<EOF
ALTER TABLE `cdb_tshuz_attachdowntimes` ADD INDEX `uid` (`uid`, `username`, `dateline`, `tid`, `ip`, `aid`) ;
ALTER TABLE `cdb_tshuz_attachdowntimes` MODIFY COLUMN `ip`  varchar(45) NULL DEFAULT NULL;
EOF;
runquery($sql);
